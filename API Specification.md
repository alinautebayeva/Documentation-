...
=======
 ...
 | has_projector | boolean | необязательный              | Наличие проектора                       |
 | floor         | integer | необязательный              | Этаж, на котором находится переговорная |
>>>>>>> e07f21acf2c23187ced4211154b1befe7cb87f88
...
| start_time | string (datetime) | Дата и время старта бронирования. Значение start_time не может быть больше значения end_time |
...
| start_time | string (YYYY-MM-DD) | обязательный  | Время старта бронирования |
| end_time | string (YYYY-MM-DD) | обязательный  | Время окончания бронирования |
### __Ответы:__ 
...
| Параметр | Тип | Обязательный/необязательный | Описание |
| --- | --- | --- | --- |
| start_time | string (YYYY-MM-DD) | обязательный  | Новое время старта бронирования |
| end_time | string (YYYY-MM-DD) | обязательный  | Новое время окончания бронирования |
